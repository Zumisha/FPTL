...
namespace UnitTests
{
	namespace Arrays
	{
		TEST(ArrayCatErrors, IntInsteadArray)
		{
			...
			FPTL::Parser::Support::printPositionalMessage(expected, 1, 19, invalidOperation("int", "toArray"));
		...
		TEST(ArrayCatErrors, DoubleInsteadArray)
		{
			...
			std::stringstream expected;
			FPTL::Parser::Support::printPositionalMessage(expected, 1, 71, invalidOperation("double", "toArray"));
		...
		TEST(ArrayCatErrors, BoolInsteadArray)
		{
			...
			std::stringstream expected;
			FPTL::Parser::Support::printPositionalMessage(expected, 1, 22, invalidOperation("boolean", "toArray"));
		...
		TEST(ArrayCatErrors, StringInsteadArray)
		{
			...
			std::stringstream expected;
			FPTL::Parser::Support::printPositionalMessage(expected, 1, 30, invalidOperation("string", "toArray"));
		...
		TEST(ArrayCatErrors, ADTInsteadArray)
		{
			...
			std::stringstream expected;
			FPTL::Parser::Support::printPositionalMessage(expected, 1, 88, invalidOperation("List['t['t]]", "toArray"));
		...
		TEST(ArrayCatErrors, DifferentTypes)
		{
			...
			std::stringstream expected;
			FPTL::Parser::Support::printPositionalMessage(expected, 1, 99, FPTL::Runtime::ArrayValue::concatErrMsg("array[array[int]]", "array[array[double]]"));
