...
public:
	...
	// »нформаци€ о конкретном типе массива во врем€ выполнени€ не сохран€етс€.
	...
	// ƒобавл€ть сюда методы по мере добавлени€ новых типов.
...
DataValue ArrayValue::create(SExecutionContext & ctx, int size, const DataValue & initial)
{
	...
	// —оздаем массив и заполн€ем его начальным значением.
