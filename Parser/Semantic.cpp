...
// Semantic.cpp - реализаци€ класса дл€ семантической проверки структуры программы.
...
void NamesChecker::visit( FunctionNode * aFunctionNode )
{
	...
	// ѕровер€ем наличие главного уравнени€.
...
void NamesChecker::checkName( STermDescriptor & aTermDesc )
{
	...
	// —начала ищем в локальном пространстве имен.
	...
	{
		// «атем ищем в глобальном пространстве имен.
